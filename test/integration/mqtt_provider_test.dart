...
void main() {
  group('MQTT Provider Integration Tests', () {
    ...
    setUp(() async {
      ...
      expect(connectResult, isA<Success<void>>(),
    ...
    test(
      ...
      () async {
        ...
        expect(receivedDevices, isNotEmpty,
    ...
    test(
      ...
      () async {
        final sensorTypes = [SensorType.temperature, SensorType.humidity, SensorType.pH];
        final receivedData = <SensorData>[];
        ...
        expect(receivedData.length, equals(sensorTypes.length),
        ...
        for (final sensorType in sensorTypes) {
          ...
          expect(matchingData, isNotEmpty,
    ...
    test(
      ...
      () async {
        ...
        // ignore: deprecated_member_use
        final connectionStream = container.read(mqttConnectionStatusProvider.stream);
    ...
    test(
      ...
      () async {
        ...
        final topic = TestMqttTopics.sensorTopicFor('rpi');
        const malformedJson = '{"deviceType": "temperature", "deviceID": "malformed", "invalid": json}';
